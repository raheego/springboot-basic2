...
public class JpaboardApplication implements CommandLineRunner{
	...
	public void run(String...args) {
		...
		Jpa_Board b7 = new Jpa_Board();
		b7.setContent("KOSA강좌 추천해 주세요6~");
		b7.setName("무명씨");		b7.setPasswd("5252");
		b7.setReadcount(0);			b7.setRegdate(new Date());
		b7.setReply(6);				b7.setReplylevel(0);
		b7.setReplystep(0);			b7.setTitle("강좌추천요망6");
